...
private:
    void object_position_callback(const sensor_msgs::msg::Image & msg) 
    {
        ...
        cv::Scalar colorLower(80, 50, 50); // Example: lower bound for blue color
        cv::Scalar colorUpper(120, 255, 255); // Example: upper bound for blue color
        ...
        {
            this->debug_object_position(mask, centroid);
        }
    }
